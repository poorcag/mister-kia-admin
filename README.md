...
If you need to remember how to run this again:

```
cloud-sql-proxy mister-kia-auth:australia-southeast2:psql-mk
```
...
vscode debugger application and navigate to `localhost:8080` in a browser
